 ...
 *
 */
public class invokeShhtXcjzoweb {
	...
	public static void main(String[] arg) {
		...
		args.put("processDefId", "obj_daa0bcf7e6d5498080b7b2ff168ca252");//下厂监制流程

		args.put("uid", "china_zh");//系统登录账号
		args.put("title", "下厂监制TITLE");//流程标题
		...
		boCreaD.put("boName","BO_EU_SHHT_CHECKNOTIFY_HEAD" );//下厂监制主表
...
//		formFile.setId("300e4423-c384-4b33-b006-a7e05ed6a1ea");
		...
		formFile.setTaskInstId("obj_5348a5aaa47c4e3e9b2555b8c60ad533");//任务实例ID
		...
		taskcomvalue.put("activityDefId","obj_5348a5aaa47c4e3e9b2555b8c60ad533" );
